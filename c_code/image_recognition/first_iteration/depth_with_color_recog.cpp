...
// https://github.com/Sleddersquid/fussball_system/blob/main/c_code/test/opencv_test/test_opencv_ball_tracker.cpp
...
int main() {
  ...
  while (true) {
    if (!cam.getVideoFrame(image, 1000)) {
      ...
      std::cout << "New center.x: " << new_center.x << 
                   " New center.y: " << new_center.y << 
                   " Radius: " << radius <<
              std::endl;
